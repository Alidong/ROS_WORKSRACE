...
echo_and_run cd "/home/orangepi/ros_workspace/src/yujin_ocs/yocs_ar_pair_approach"
...
echo_and_run /usr/bin/env \
    ...
    "/home/orangepi/ros_workspace/src/yujin_ocs/yocs_ar_pair_approach/setup.py" \
     \
    build --build-base "/home/orangepi/ros_workspace/build/yujin_ocs/yocs_ar_pair_approach" \
    install \
    --root="${DESTDIR-/}" \
