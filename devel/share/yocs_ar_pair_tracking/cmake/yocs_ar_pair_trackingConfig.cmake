...
if("TRUE" STREQUAL "TRUE")
  set(yocs_ar_pair_tracking_SOURCE_PREFIX /home/orangepi/ros_workspace/src/yujin_ocs/yocs_ar_pair_tracking)
  set(yocs_ar_pair_tracking_DEVEL_PREFIX /home/orangepi/ros_workspace/devel)
  ...
  set(yocs_ar_pair_tracking_INSTALL_PREFIX /home/orangepi/ros_workspace/install)
...
if(NOT "/home/orangepi/ros_workspace/src/yujin_ocs/yocs_ar_pair_tracking/include;/usr/include " STREQUAL " ")
  set(yocs_ar_pair_tracking_INCLUDE_DIRS "")
  set(_include_dirs "/home/orangepi/ros_workspace/src/yujin_ocs/yocs_ar_pair_tracking/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'yocs_ar_pair_tracking' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/orangepi/ros_workspace/src/yujin_ocs/yocs_ar_pair_tracking/${idir}'.  ${_report}")
    endif()
    _list_append_unique(yocs_ar_pair_tracking_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "yocs_ar_pair_tracking;/usr/lib/aarch64-linux-gnu/libboost_system.so")
