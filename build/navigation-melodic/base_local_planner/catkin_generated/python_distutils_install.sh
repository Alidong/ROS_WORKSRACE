...
echo_and_run cd "/home/orangepi/ros_workspace/src/navigation-melodic/base_local_planner"
...
echo_and_run /usr/bin/env \
    ...
    "/home/orangepi/ros_workspace/src/navigation-melodic/base_local_planner/setup.py" \
     \
    build --build-base "/home/orangepi/ros_workspace/build/navigation-melodic/base_local_planner" \
    install \
    --root="${DESTDIR-/}" \
