...
echo_and_run cd "/home/orangepi/ros_workspace/src/unique_identifier/unique_id"
...
echo_and_run /usr/bin/env \
    ...
    "/home/orangepi/ros_workspace/src/unique_identifier/unique_id/setup.py" \
     \
    build --build-base "/home/orangepi/ros_workspace/build/unique_identifier/unique_id" \
    install \
    --root="${DESTDIR-/}" \
